...
import static com.example.aliothman.baking.SecondFragment.steps;

/**
 * Created by Ali Othman on 21/06/2017.
 */

public class ThirdFragment extends Fragment implements ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE && !the_tab) {
            hideSystemUI();
    ...
    private void initializePlayer(Uri mediaUri) {
        if (exoPlayer == null) {
            ...
            String userAgent = Util.getUserAgent(getContext(), "ThirdFragment");
